...
class _StandardUiTextFieldStyle extends UiTextFieldStyle {
  ...
  @override
  TextStyle? get counterStyle => typography.labelSmall
      .copyWith(color: palette.foreground.withOpacity(.58));
        ...
        (states) {
          if (states.contains(WidgetState.disabled)) {
            return typography.bodyMedium
                .copyWith(color: palette.foreground.withOpacity(.38));
          }
  ...
  TextStyle? get helperStyle =>
      typography.bodySmall.copyWith(color: palette.foreground.withOpacity(.58));
